...
#### Поддерживаемые типы данных
  ...
  2. значение — нуль­терминированная строка произвольной длины.
#### Содержимое узла
  Узел дерева должен содержать:
  1. ключ;
  2. указатели на правое и левое поддеревья;
  3. указатель на следующий и/или предыдущий узлы (в соответствии с операцией обхода);
  4. указатель на родительский узел;
  5. указатель на информационное поле.
